            ...
            return NextResponse.json(
              {
                ...
                errorDetails:
                  "The Perplexity API key was rejected. Please check that your API key is valid and has not expired.",
                choices: [
                  {
                    message: {
                      content: JSON.stringify({
                        ...
                        summary:
                          "We encountered an authentication issue while trying to research your query.",
                        details:
                          "The API key used to access the research service is invalid or has expired. This requires administrative attention.",
                        actionableSteps: [
              ...
              choices: [
                {
                  message: {
                    content: JSON.stringify({
                      ...
                      summary:
                        "We encountered an issue while trying to research your query.",
                      details:
                        "The research service is currently unavailable. This could be due to high demand or temporary service disruption.",
                      actionableSteps: [
        ...
        if (data.choices && data.choices[0] && data.choices[0].message) {
          ...
          try {
            ...
            if (content.includes("<think>") && content.includes("</think>")) {
              ...
              console.log(
                "Content after removing thinking sections:",
            ...
            if (cleanedContent.includes("```json")) {
              ...
              console.log(
                "Content after removing markdown code blocks:",
                cleanedContent.substring(0, 100) + "..."
              );
            }
              ...
              choices: [
                {
                  message: {
                    content: JSON.stringify({
                      ...
                      summary:
                        "We received an unexpected response format from the research service.",
                      details:
                        "The research service returned data in a format that we couldn't process. This is likely a temporary issue.",
                      actionableSteps: [
                        "Try again in a few minutes",
                        "Refresh the page and submit your query again",
                        "Try a different, more specific query",
          ...
          return NextResponse.json(
            {
              ...
              errorDetails:
                "The request to the Perplexity API timed out after 90 seconds.",
              choices: [
                {
                  message: {
                    content: JSON.stringify({
                      ...
                      summary:
                        "Your research query took too long to process and timed out.",
                      details:
                        "This can happen with complex queries or during periods of high demand. The research service was unable to complete your request within the allocated time.",
                      actionableSteps: [
        ...
        choices: [
          {
            message: {
              content: JSON.stringify({
                ...
                summary:
                  "We were unable to complete your research query after multiple attempts.",
                details:
                  "The research service is experiencing persistent issues. This could be due to network problems, service outages, or high demand.",
                actionableSteps: [
        ...
        choices: [
          {
            message: {
              content: JSON.stringify({
                ...
                summary:
                  "An unexpected error occurred while processing your research query.",
                details:
                  "Our system encountered an error that it wasn't expecting. This has been logged for investigation.",
                actionableSteps: [
                  "Try again later",
                  "Refresh the page and submit your query again",
